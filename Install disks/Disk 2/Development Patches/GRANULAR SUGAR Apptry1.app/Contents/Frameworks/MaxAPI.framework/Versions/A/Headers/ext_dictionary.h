...
/** A dictionary entry. This struct is provided for debugging convenience, 
...
// private
t_max_err dictionary_appendattribute(t_dictionary *d, t_symbol *key, t_symbol *attrname, t_object *obj);  
...
t_max_err dictionary_appendobject_flags(t_dictionary *d, t_symbol *key, t_object *value, long flags); 


t_max_err dictionary_appendbinbuf(t_dictionary *d, t_symbol *key, void *value); 
